...
def minimax(board, depth, alpha, beta, current_player, ai_player, make_move, evaluate_fn=None):
    """
    ...
    if depth == 0 or sum(board[1:7]) == 0 or sum(board[8:14]) == 0:
        return evaluate_fn(board, ai_player), None
    ...
    if current_player == ai_player:
        ...
        for move in moves:
            ...
            eval_val, _ = minimax(temp_board, next_depth, alpha, beta, next_p, ai_player, make_move, evaluate_fn)
